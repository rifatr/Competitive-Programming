...
// Contest: Virtual Judge - Topic : Segment Tree
// URL: https://vjudge.net/contest/437916#problem/B
// Time: 2022-02-01 13:03:25
...
int findans(int l, int r) {
	int mx1 = findmax(1, l, r, 1, n);
	int mx2 = findmax(1, l, mx1 - 1, 1, n);
	int mx3 = findmax(1, mx1 + 1, r, 1, n);
	
	return a[mx1] + max(a[mx2], a[mx3]);
}
