...
sob > void debug(unordered_set <T> v) {cout << "[ "; for (T z : v) debug(z); cout << "]";}
sob > void debug(multiset <T> v) {cout << "[ "; for (T z : v) debug(z); cout << "]";}
sob > void debug(queue <T> q) {cout << "[ "; while(!q.empty()) {debug(q.front()); q.pop();} cout << "]";}
sob > void debug(priority_queue <T> q) {cout << "[ "; while(!q.empty()) {debug(q.top()); q.pop();} cout << "]";}
sob > void debug(stack <T> q) {cout << "[ "; while(!q.empty()) {debug(q.top()); q.pop();} cout << "]";}
...
sb2 > void debug(unordered_map <T, TT> v) {cout << "[ "; for (auto z : v) debug(z); cout << "]";}
sb2 > void debug(unordered_map <T, vector<TT>> v) {cout << "\n"; for (auto z : v) cout << "\t" << z.first << " -> ", debug(z.second), cout << '\n';}
sb2 > void debug(unordered_map <T, deque<TT>> v) {cout << "\n"; for (auto z : v) cout << "\t" << z.first << " -> ", debug(z.second), cout << '\n';}
sb2 > void debug(unordered_map <T, set<TT>> v) {cout << "\n"; for (auto z : v) cout << "\t" << z.first << " -> ", debug(z.second), cout << '\n';}
sb2 > void debug(unordered_map <T, multiset<TT>> v) {cout << "\n"; for (auto z : v) cout << "\t" << z.first << " -> ", debug(z.second), cout << '\n';}
